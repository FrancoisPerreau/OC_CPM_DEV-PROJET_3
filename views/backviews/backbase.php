		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav mr-auto">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="../public/index.php?route=profil">commentaires</a>
					</li>

					<li class="nav-item">
						<a class="nav-link" href="../public/index.php?route=profil">chapitres</a>
					</li>

					<li class="nav-item">
						<a class="nav-link" href="../public/index.php?route=profil">créer un chapitre</a>
					</li>

					<li class="nav-item">
						<a class="nav-link" href="../public/index.php?route=profil">profil</a>
					</li>
